...
//    $onload = '';
    ...
    $script = '<script src="'.$CFG->wwwroot.'/filter/chart/codebase/dhtmlxcommon.js"></script>';
    $script .= '<link rel="stylesheet" href="'.$CFG->wwwroot.'/filter/chart/codebase/dhtmlxchart.css">';
    $script .= '<script src="'.$CFG->wwwroot.'/filter/chart/codebase/dhtmlxchart.js"></script>';
    $script .= '<link rel="stylesheet" href="'.$CFG->wwwroot.'/filter/chart/codebase/dhtmlxgrid.css">';
    $script .= '<script src="'.$CFG->wwwroot.'/filter/chart/codebase/dhtmlxgrid.js"></script>';
